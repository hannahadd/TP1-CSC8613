...
usage_agg_30d_source = PostgreSQLSource(
    ...
    query="""
        SELECT
            user_id,
            as_of,
            watch_hours_30d::float AS watch_hours_30d,
            avg_session_mins_7d::float AS avg_session_mins_7d,
            unique_devices_30d,
            skips_7d,
            rebuffer_events_7d
...
support_agg_90d_source = PostgreSQLSource(
    ...
    query="""
        SELECT
            ...
            as_of,
            support_tickets_90d,
            ticket_avg_resolution_hrs_90d::float AS ticket_avg_resolution_hrs_90d
